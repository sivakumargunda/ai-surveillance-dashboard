"""
main_threaded.py - FULL THREADED PIPELINE FOR 20+ FPS
...
def output_thread():
    ...
    while not stop_event.is_set():
        ...
        if frame_count % 30 == 0:
            ...
            last_time = now
            print(f"FPS: {fps:.1f} | People: {people} | Total: {frame_count} | Avg People: {people_total/frame_count:.1f}")
        ...
        # Show every 30 frames (not every frame - faster)
        if frame_count % 30 == 0:
